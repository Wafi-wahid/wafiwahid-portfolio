export const site = {
  ...
  services: [
    {
      ...
      description:
        "End-to-end web apps with React, Next.js, APIs, and reliable databases—built to scale cleanly.",
    },
    {
      number: "02",
      title: "UI / UX Engineering",
      description:
        "Responsive interfaces with strong hierarchy, accessibility, and motion that supports the product.",
    },
    {
      number: "03",
  ...
  skillLevels: [
    ...
    { name: "AI / ML tooling", level: 72 },
  ],
  testimonials: [
    {
      quote:
        "Wafi ships clean, thoughtful interfaces and communicates clearly through every iteration.",
